...
public class ToyVpnService extends VpnService implements Handler.Callback {
    ...
    public static final String ACTION_CONNECT = "com.example.vpnmodule.START";
    public static final String ACTION_DISCONNECT = "com.example.vpnmodule.STOP";
    ...
    public void onCreate() {
        ...
        mConfigureIntent = PendingIntent
                .getActivity(this, 0,
                        new Intent(this, ToyVpnClient.class),
